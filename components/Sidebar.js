    ...
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 flex-col justify-between bg-ink px-4 py-6 lg:flex">
      ...
      <div className="border-t border-white/10 pt-4">
        <div className="flex items-center gap-3 rounded-xl px-2 py-2">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gold/20 text-xs font-medium text-gold-light">
        ...
        <button
          ...
          className="mt-1 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-paper/50 transition hover:bg-rust/10 hover:text-rust"
        >
