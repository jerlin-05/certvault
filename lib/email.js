...
export async function sendOtpEmail({ to, recipientName, otp }) {
  const subject = `Your CertVault verification code: ${otp}`;
  ...
  <div style="background:#F2EFE8;padding:32px 16px;font-family:Georgia,'Times New Roman',serif;">
    <div style="max-width:520px;margin:0 auto;background:#FAF9F6;border:1px solid #E7E2D6;">
      <div style="background:#0E1526;padding:24px 32px;">
        ...
        <h1 style="color:#FAF9F6;font-size:20px;margin:8px 0 0;font-weight:normal;">Verify your email</h1>
      </div>
      <div style="padding:32px;">
        ...
        <p style="color:#0E1526;font-size:15px;line-height:1.6;font-family:Arial,sans-serif;">
          Use the code below to verify your email and finish setting up your CertVault account. It expires in 10 minutes.
        </p>
        <div style="text-align:center;margin:28px 0;">
          <span style="display:inline-block;background:#0E1526;color:#FAF9F6;letter-spacing:0.3em;font-size:28px;font-weight:bold;padding:16px 28px;font-family:Arial,sans-serif;">${otp}</span>
        </div>
        <p style="color:#8A93A0;font-size:12px;margin-top:12px;font-family:Arial,sans-serif;">
          If you didn't try to create a CertVault account, you can safely ignore this email.
        </p>
      </div>
    </div>
  </div>`;
...
Your CertVault verification code is: ${otp}
