  ...
  <div style="background:#F2EFE8;padding:32px 16px;font-family:Georgia,'Times New Roman',serif;">
    <div style="max-width:520px;margin:0 auto;background:#FBFAF7;border:1px solid #E4DFD3;">
      <div style="background:#121B2E;padding:24px 32px;">
        ...
        <h1 style="color:#FBFAF7;font-size:20px;margin:8px 0 0;font-weight:normal;">Reset your password</h1>
      </div>
      <div style="padding:32px;">
        ...
        <a href="${resetUrl}" style="display:inline-block;background:#121B2E;color:#FBFAF7;text-decoration:none;padding:12px 24px;font-size:14px;font-family:Arial,sans-serif;margin-top:12px;">Reset password</a>
        ...
        <p style="color:#121B2E;font-size:15px;line-height:1.6;font-family:Arial,sans-serif;">
          ${
            daysRemaining < 0
              ...
              : daysRemaining === 0
                ? `Your certificate <strong>${certificateName}</strong> expires <strong style="color:#A1352B;">today</strong>.`
